...
[Live Demo](https://ckeditor5.adriancs.com/) | [adriancs.com](https://adriancs.com/aspnet-webforms/884/using-ckeditor-5-with-code-block-highlight-js-output-in-asp-net/)
...
Therefore, we can use `Highlight.js` (a javascript syntax highlighting tool) to highlight the generated output by CKEditor.
